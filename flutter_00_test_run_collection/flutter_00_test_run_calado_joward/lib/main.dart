...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Test Run By Joward Calado',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 1, 12, 3)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Flutter Test Run Homepage By Joward Calado'),
    );
  }
}
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              'My Name is Joward',
              style: TextStyle(fontSize: 16, color: Color.fromARGB(255, 7, 3, 3)),
            ),
          ],
        ),
      ),
