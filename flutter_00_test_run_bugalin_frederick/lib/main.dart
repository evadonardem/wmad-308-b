...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Test Run By Yours: Frederick Bugalin',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 1, 12, 3)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Flutter Test Run Homepage By Him: Frederick Bugalin'),
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              ...
              style: TextStyle(fontSize: 16, color: Color.fromARGB(255, 204, 118, 118)),
            ),
          ],
        ),
      ),
