...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: '🐶Adopt Lovely Dogs🐾',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
            seedColor: const Color.fromARGB(255, 67, 135, 224)),
        useMaterial3: true,
      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: const Color.fromARGB(255, 75, 141, 228),
        unselectedItemColor: const Color.fromARGB(255, 2, 63, 133),
        onTap: _onItemTapped,
      ),
    );
  }
...
class AdoptedDogsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Adopted Dogs❤️')),
                  ...
                  child: ListTile(
                    ...
                    trailing: IconButton(
                      icon: const Icon(Icons.undo,
                          color: Color.fromARGB(255, 255, 92, 81)), // Undo icon for returning dogs
                      onPressed: () {
            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(
                    ...
                    color: Color.fromARGB(255, 54, 138, 216)),
              ...
              // Description
              const Text(
                "Lovely Dogs helps you find your new best friend. Browse adoptable dogs and bring joy to your home! 🐕",
                style:
              ...
              ElevatedButton.icon(
                ...
                icon: const Icon(Icons.pets, size: 25, color: Color.fromARGB(255, 49, 235, 111)),
                label: const Text(
                  'Adopt Now!🐾',
                  style: TextStyle(
                      fontSize: 18,
                      color: Color.fromARGB(255, 14, 92, 236),
                      fontWeight: FontWeight.bold),
                ),
                style: ElevatedButton.styleFrom(
                  padding: EdgeInsets.symmetric(horizontal: 30, vertical: 12),
                  backgroundColor: const Color.fromARGB(255, 54, 130, 216),
