  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "✨ Why Choose Pawfect Companions?",
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 5),
            const Text(
              "✅ Explore Incredible Dogs – From energetic Border Collies to snuggly French Bulldogs, discover the perfect match for your family.\n\n"
              "✅ Adopt Stress-Free – With a simple, user-friendly process, bringing a dog into your home has never been easier.\n\n"
              "✅  Rehome with Heart – If you're looking to give a dog a new chance, we help you navigate the rehoming process with care and compassion.\n\n"
              "✅ Each Adoption is Special – No two dogs are alike. Every pup’s journey is unique, and we ensure they find the right home.",
              style: TextStyle(fontSize: 16),
            ),
            const SizedBox(height: 15),
            const Text(
      ...
      "",
            ...
            const SizedBox(height: 5),
            const Text(
              "At Pawfect Companions, our mission is simple: to reduce the number of homeless dogs by making adoption easy, safe, and full of love. Every dog deserves a family who will care for them and give them a life full of joy and companionship. Together, we can make a difference—one wagging tail at a time! 🐶",
              style: TextStyle(fontSize: 16),
            ),
            const SizedBox(height: 20),
            const Center(
              child: Text(
                "📍 Join Us Today! Help give a dog the life they deserve. Start your journey today! 🐾",
                style: TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
