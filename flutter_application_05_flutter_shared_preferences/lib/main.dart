...
class _MyAppState extends State<MyApp> {
        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              _buildSwitchTile(
                  'Dark Mode', 'Dark Mode', _darkMode, Icons.dark_mode),
              _buildSwitchTile(
                  'Enable Setting 1', 'Setting 1', _setting1, Icons.settings),
              _buildSwitchTile(
                  'Enable Setting 2', 'Setting 2', _setting2, Icons.settings),
              _buildSwitchTile(
                  'Enable Setting 3', 'Setting 3', _setting3, Icons.settings),
            ],
          ),
        ),
      ),
  ...
  Widget _buildSwitchTile(String title, String key, bool value, IconData icon) {
    return ListTile(
      ...
      trailing: Switch(
        value: value,
        activeColor: const Color.fromRGBO(12, 180, 231, 1),
