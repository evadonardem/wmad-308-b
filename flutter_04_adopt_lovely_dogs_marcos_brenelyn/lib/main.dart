  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        scaffoldBackgroundColor: const Color.fromARGB(255, 185, 231, 237),
        useMaterial3: true,
      ),
      home: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          selectedItemColor: const Color.fromARGB(255, 73, 182, 166),
          unselectedItemColor: const Color.fromARGB(255, 88, 69, 69),
          backgroundColor: const Color.fromARGB(255, 69, 80, 180),
          onTap: _onItemTapped,
        ),
      ),
    );
...
class AboutPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("About"), backgroundColor: const Color.fromARGB(255, 64, 255, 252)),
      body: const Center(
        child: Padding(
          padding: EdgeInsets.all(16.0),
          child: Text(
            "Welcome to Lovely Dogs!\n\n Where you can search and adopt friendly and lovely dogs!\n\n Give them the love they deserve. \n\n -by Marcos, Brenelyn ",
...
class GaveAwayDogsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Gave Away Dogs"), backgroundColor: const Color.fromARGB(255, 103, 249, 205)),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text("Breed: ${dog.breed.toLowerCase()}", style: const TextStyle(color: Colors.black54)),
                        ],
                      ),
                    ),
                  ),
...
class _AdoptedDogsPageState extends State<AdoptedDogsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Adopted Dogs"), backgroundColor: const Color.fromARGB(255, 136, 248, 205)),
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              foregroundColor: const Color.fromARGB(255, 100, 236, 218),
                              side: const BorderSide(color: Color.fromARGB(255, 25, 238, 213), width: 2),
                            ),
                          ),
                        ],
                      ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Adopted Dogs"), backgroundColor: const Color.fromARGB(255, 69, 226, 197)),
      body: adoptedDogs.isEmpty
          ? const Center(child: Text("No adopted dogs yet!", style: TextStyle(fontSize: 18)))
          : ListView.builder(
              itemCount: adoptedDogs.length,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 4, 173, 167),
      ),
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 1, 33, 35)),
              ),
              const SizedBox(height: 4),
              const Text(
                "Choose a breed and find your perfect furbaby!",
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: const Color.fromARGB(255, 3, 177, 151), width: 2),
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton.icon(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: isAdopted ? const Color.fromARGB(255, 30, 226, 233) : Colors.white,
                                  foregroundColor: isAdopted ? Colors.white : const Color.fromARGB(255, 4, 154, 168),
                                  side: const BorderSide(color: Color.fromARGB(255, 30, 233, 233), width: 2),
                                ),
                              ),
                              ...
                              ElevatedButton.icon(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: Colors.white,
                                  foregroundColor: const Color.fromARGB(255, 30, 233, 220),
                                  side: const BorderSide(color: Color.fromARGB(255, 30, 226, 233), width: 2),
                                ),
                              ),
                            ],
                          ),
