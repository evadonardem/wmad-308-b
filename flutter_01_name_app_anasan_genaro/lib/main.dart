  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 255, 36, 73)),
        ),
        home: MyHomePage(),
      ),
    );
...
class GeneratorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    IconData dislikeIcon =
        appState.dislikes.contains(pair) ? Icons.thumb_down : Icons.thumb_down_alt_outlined;
