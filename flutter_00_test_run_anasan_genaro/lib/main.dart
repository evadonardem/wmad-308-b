...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Test Run By:Anasan Genaro',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 1, 12, 3)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Flutter Test Run Homepage By: Anasan Genaro'),
    );
  }
}
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              'My Name is Genaro',
              style: TextStyle(fontSize: 16, color: Color.fromARGB(255, 0, 70, 223)),
            ),
          ],
        ),
      ),
