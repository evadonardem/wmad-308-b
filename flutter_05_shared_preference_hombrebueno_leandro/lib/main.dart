...
class _MyAppState extends State<MyApp> {
  ...
  Color _getBackgroundColor() {
    if (_setting1) {
      return const Color.fromARGB(255, 0, 163, 228);
    } else if (_setting2) {
      return const Color.fromARGB(255, 243, 187, 2);
    } else if (_setting3) {
      return const Color.fromARGB(255, 7, 49, 236);
    }
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('Setting 1 (Sky Blue Background):'),
              Switch(
                value: setting1,
                onChanged: (value) => onPreferenceChanged('setting1', value),
              ),
              const Text('Setting 2 (Yellow Background):'),
              Switch(
                value: setting2,
                onChanged: (value) => onPreferenceChanged('setting2', value),
              ),
              const Text('Setting 3 (Dark Blue Background):'),
              Switch(
                value: setting3,
