...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Find Your Furry Best Friend!'), centerTitle: true),
  ...
  return Scaffold(
    ...
    body: Padding(
      ...
      child: Column(
        ...
        children: [
          const Text(
            "🐶 Welcome to Furry Haven!",
            style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 10),
          const Text(
            "At Furry Haven, we are dedicated to connecting loving families with dogs in need of a forever home. "
            "Our platform is designed to make pet adoption seamless, ensuring that every pup finds the right family and every adopter finds their perfect furry companion.",
          ...
          const Text(
            "✔ **Wide Variety of Pups** – Whether you’re looking for an energetic companion or a cuddly friend, we have dogs of all breeds and sizes.\n\n"
            "✔ **Simple & Hassle-Free Process** – Find your new best friend in just a few steps, without unnecessary complications.\n\n"
            ,
            style: TextStyle(fontSize: 16),
          ),
          const SizedBox(height: 15),
          ...
          const SizedBox(height: 5),
          const Text(
            "🔹 **Browse Our Adorable Pups** – View detailed profiles with pictures and personality traits.\n\n"
            "🔹 **Find Your Perfect Match** – Choose the dog that fits your lifestyle and complete the adoption request.\n\n"
            ,
            style: TextStyle(fontSize: 16),
          ),
          const SizedBox(height: 15),
          ...
          const SizedBox(height: 5),
          const Text(
            "We believe that every dog deserves love, care, and a safe home. Our mission is to reduce pet homelessness "
            "by making adoption accessible and trustworthy. With your support, we can create happy endings for countless furry friends! 🐕💕",
            style: TextStyle(fontSize: 16),
          ),
          const SizedBox(height: 20),
          const Center(
            child: Text(
              "🏠 Open Your Heart & Home – Adopt a Dog Today! 🐾",
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.bold,
