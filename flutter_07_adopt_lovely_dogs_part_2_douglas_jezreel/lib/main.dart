    ...
    return MaterialApp(
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.light(
          primary: Color.fromARGB(255, 44, 16, 170),
          secondary: Color.fromARGB(255, 75, 9, 39),
          surface: Color(0xFFFFEBEE),
          background: Colors.white,
        ),
        appBarTheme: AppBarTheme(
          backgroundColor: Color.fromARGB(255, 143, 53, 84),
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            backgroundColor: Color.fromARGB(255, 51, 167, 47),
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const <Widget>[
          NavigationDestination(
            selectedIcon: Icon(
              Icons.home,
              color: Color.fromARGB(255, 12, 179, 142),
            ),
          ...
          NavigationDestination(
            selectedIcon: Icon(
              Icons.pets,
              color: Color.fromARGB(255, 13, 197, 96),
            ),
          ...
          NavigationDestination(
            selectedIcon: Icon(
              Icons.info,
              color: Color.fromARGB(255, 15, 168, 117),
            ),
...
class MessagesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Theme.of(context).colorScheme.surface,
      appBar: AppBar(title: const Text('Given Away Dogs'), centerTitle: true),
      body:
          givenAwayDogs.isEmpty
              ? Center(
                child: Column(
