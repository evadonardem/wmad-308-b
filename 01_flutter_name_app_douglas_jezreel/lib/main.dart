  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 255, 163, 220)),
        ),
        home: MyHomePage(),
      ),
    );
...
class MyAppState extends ChangeNotifier {
  ...
  void removeFromDislikes(WordPair pair) {
...
class AboutMePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: BigCard(pair: WordPair('Jezreel', 'Douglas')),
    );
  }
}
        ...
        for (var pair in appState.dislikes)
          ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                appState.removeFromDislikes(pair);
              },
            ),
          ),
      ],
