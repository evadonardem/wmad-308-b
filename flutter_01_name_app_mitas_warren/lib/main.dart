...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        title: 'Namer_App_By_Mitas_Warren',
        theme: ThemeData(
          useMaterial3: true,
          colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 46, 45, 45)!),
        ),
        home: MyHomePage(),
      ),
    );
          ...
          children: [
            Text(
              ...
              style: Theme.of(context).textTheme.headlineMedium!.copyWith(
                color: Theme.of(context).colorScheme.onSecondary, // Use onPrimary or any color
              ),
            ),
            SizedBox(height: 10),
            Text(
              'Namer App By : Mitas, Warren D.',
              style: TextStyle(
                fontSize: 18,
